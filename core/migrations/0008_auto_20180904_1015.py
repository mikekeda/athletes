# Generated by Django 2.1 on 2018-09-04 10:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='athlete',
            name='category',
            field=models.CharField(blank=True, choices=[('Football', 'Football'), ('Rugby', 'Rugby'), ('Athletics', 'Athletics'), ('Cycling', 'Cycling'), ('Swimming', 'Swimming'), ('Gymnastics', 'Gymnastics'), ('Golf', 'Golf'), ('American Football', 'American Football'), ('Basketball', 'Basketball'), ('Baseball', 'Baseball'), ('College Football', 'College Football'), ('College Basketball', 'College Basketball'), ('Ice Hockey', 'Ice Hockey')], max_length=255),
        ),
        migrations.AlterField(
            model_name='athlete',
        ...
        migrations.AlterField(
            model_name='athlete',
            name='gender',
            field=models.CharField(blank=True, choices=[('male', 'Male'), ('female', 'Female')], default='male', max_length=15),
        ),
        migrations.AlterField(
            model_name='athlete',
            name='instagram',
        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(blank=True, choices=[(1, 'January'), (2, 'February'), (3, 'March'), (4, 'April'), (5, 'May'), (6, 'June'), (7, 'July'), (8, 'August'), (9, 'September'), (10, 'October'), (11, 'November'), (12, 'December')]),
        ),
        migrations.AlterField(
            model_name='athlete',
            name='team',
