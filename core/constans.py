...
_COUNTRIES = (
    ...
    ("BM", "BMU", "Bermuda", 60),
    ("BT", "BTN", "Bhutan", 64),
    ("BO", "BOL", "Bolivia (Plurinational State of)", 68),
    ...
    ("IS", "ISL", "Iceland", 352),
    ("IN", "IND", "India", 356),
    ("ID", "INA", "Indonesia", 360),
    ("IR", "IRI", "Iran (Islamic Republic of)", 364),
    ("IQ", "IRQ", "Iraq", 368),
    ("IE", "IRL", "Ireland", 372),
    ...
    ("KE", "KEN", "Kenya", 404),
    ("KI", "KIR", "Kiribati", 296),
    ("KP", "PRK", "Korea (the Democratic People's Republic of)", 408),
    ("KR", "KOR", "Korea (the Republic of)", 410),
    ("KW", "KUW", "Kuwait", 414),
    ...
    ("MO", "MAC", "Macao", 446),
    ("MK", "MKD", "Macedonia (the former Yugoslav Republic of)", 807),
    ...
    ("MD", "MDA", "Moldova (the Republic of)", 498),
    ("MC", "MON", "Monaco", 492),
    ("MN", "MNG", "Mongolia", 496),
    ...
    ("MP", "NMI", "Northern Mariana Islands", 580),
    ("NO", "NOR", "Norway", 578),
    ("OM", "OMA", "Oman", 512),
    ("PK", "PAK", "Pakistan", 586),
    ("PW", "PLW", "Palau", 585),
    ...
    ("PY", "PAR", "Paraguay", 600),
    ("PE", "PER", "Peru", 604),
    ("PH", "PHI", "Philippines", 608),
    ("PN", "PCN", "Pitcairn", 612),
    ("PL", "POL", "Poland", 616),
    ("PT", "POR", "Portugal", 620),
    ("PR", "PUR", "Puerto Rico", 630),
    ("QA", "QAT", "Qatar", 634),
    ("RE", "REU", "Réunion", 638),
    ("RO", "ROU", "Romania", 642),
    ...
    ("GB", "GBR", "United Kingdom of Great Britain and Northern Ireland", 826),
...
COUNTRIES = {country[0]: country[2] for country in _COUNTRIES}
REVERSED_COUNTRIES = {val: key for key, val in COUNTRIES.items()}
COUNTRY_CODE3_TO_CODE2 = {country[1]: country[0] for country in _COUNTRIES}
COUNTRY_NUM_TO_CODE3 = {country[3]: country[0] for country in _COUNTRIES}
